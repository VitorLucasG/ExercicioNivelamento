...
{
    public class ReadMovimentoRepository : BaseRepository<MovimentoEntity>, IReadMovimentoRepository
    {
        public ReadMovimentoRepository(IDapperContext context) : base(context)
        {
        }
    }
}
